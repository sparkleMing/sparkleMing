package com.sumixer.ys.api.sdk.yly;
...
public class YlyMethods {
    ...
    private static class SingleMethods {
        private static final YlyMethods COCOS_MANGER = new YlyMethods();
    }

    public static final YlyMethods getInstance() {
